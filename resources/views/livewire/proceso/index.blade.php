                    ...
                    <div class="card-body">
                        <table class="table table-striped table-bordered table-hover table-checkable table-sm" id="project_list_table">
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item" href="#" wire:click="edit('{{$process_data->id}}')" data-toggle="modal" data-target="#exampleModal">{{ __('Edit') }}</a>
                                                <a class="dropdown-item" href="#" wire:click="resetForm('{{$process_data->id}}')" data-toggle="modal" data-target="#exampleModal" >{{ __('Add Subprocess') }}</a>
                                                <a class="dropdown-item" href="#" wire:click="showDeleteConfirmationModal('{{$process_data->id}}')" data-toggle="modal" data-target="#delete_modal">{{ __('Delete') }}</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="3">
                                        @include('livewire.proceso.partials.subproceso-list')
                                    </td>
                                </tr>
                                @endif
                                @endforeach
