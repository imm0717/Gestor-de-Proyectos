                        ...
                        <form class="">
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label font-weight-bold">{{ __('Project') }}
                                            :</label>
                                        <div class="col-sm-8">
                                            <a class="form-control-plaintext" href="{{ route('project.detail', $task->project) }}">{{ $task->project->translate($default_locale)->name }}</a>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label font-weight-bold">{{ __('Responsible') }}
                                            :</label>
                                        <div class="col-sm-8">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label font-weight-bold">{{ __('Parent Task') }}
                                            :</label>
                                        <div class="col-sm-8">
                                            <a class="form-control-plaintext" href="{{ route('task.detail', $task->parent) }}">{{ $task->parent->translate($default_locale)->name }}</a>
                                        </div>
                                    </div>
                                    @endif
                                    <div class="form-group row">
